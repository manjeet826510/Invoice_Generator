...
<body>
    ...
    <div class="container">
        <div class="form-section">
            <div class="login-in-section">
                ...
                <p class="signup-box">
                    ...
                    <span class="signup"><a href="/Invoice-gen/signup.php">Signup</a></span>
                </p>
                <?php 
                if ($login) {
            ...
            <form action="/Invoice-gen/login.php" method="post" class="form">
        ...
        <div class="right-img-section">
            <img src="/Invoice-gen/login-img.png" alt="right-img" class="right-img">
        </div>
    </div>
</body>
