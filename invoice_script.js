...
<td ><input type="number" placeholder="0" id="rate${current_rows}" class="rate${current_rows}" value="" name="rate[]"></td>
<td id="qty"><input type="number" name="qty[]" placeholder="0" id="qty${current_rows}" class="qty${current_rows}"></td>
<td class="amt"><input type="number" placeholder="₹ 0" id="amt${current_rows}" class="amt${current_rows}" name="amount[]" readonly></td>`;
