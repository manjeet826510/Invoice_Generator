...
<body>
    ...
    <div class="container">
        <div class="form-section">
            <div class="sign-up-section">
                ...
                <p>
                    ...
                    <span class="login"><a href="/Invoice-gen/login.php">Log in</a></span>
                </p>
            </div>
            <form action="/Invoice-gen/signup.php" method="post" class="form">
        ...
        <div class="right-img-section">
            <img src="/Invoice-gen/new-user.png" alt="right-img" class="right-img">
